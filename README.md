...
### Using the bot
The prefix to use the bot is `` *Example: daily.*
...
We are not supporting/encouraging self hosting this bot. The code is here because we use Github for the code and so you know there isn't anything suspicous.
